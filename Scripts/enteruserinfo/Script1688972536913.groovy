...
WebUI.sendKeys(findTestObject('Object Repository/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_3423e9'), Keys.chord(
        Keys.ENTER))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_3423e9'), 
    'ehNzmtMb8aWPFpI5BqBSjQ==')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_0dff71'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Epic sadface Username and password do n_e703ed'))
...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Epic sadface Username and password do n_d62622'))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_first-name'), 'test')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_last-name'), 'teat')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postal-code'), '11000')
